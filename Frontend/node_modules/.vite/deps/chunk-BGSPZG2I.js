...
function useEventCallback(fn2) {
  const ref = React39.useRef(fn2);
  useEnhancedEffect_default(() => {
    ref.current = fn2;
  });
  return React39.useRef((...args) => (
...
function useForkRef(...refs) {
  const cleanupRef = React40.useRef(void 0);
  const refEffect = React40.useCallback((instance) => {
...
function getReactElementRef(element) {
  var _a;
  if (parseInt(React56.version, 10) >= 19) {
...
var PopperTooltip = React58.forwardRef(function PopperTooltip2(props, forwardedRef) {
  ...
  const [resolvedAnchorElement, setResolvedAnchorElement] = React58.useState(resolveAnchorEl(anchorEl));
  React58.useEffect(() => {
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-BGSPZG2I.js.map
